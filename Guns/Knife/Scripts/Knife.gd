...
const h_weight:int = 80 # Stiffness of the gun while moving camera horizontally
const v_weight:int = 65 # Stiffness of the gun while moving camera vertically
const weight:int = 0 # How much the player slows down while holding this gun
const reload_time:float = 0.01 # How long it takes to reload (Independent of reload animation)
const hip_offset:float = 0.001 # The maximum angle the raycast can rotate when not ads
const inf_ammo:bool = true # Boolean of if the gun has inf ammo or not
const can_aim:bool = false # Boolean of if the gun can aim
const piercing:bool = true # Boolean of if the gun has armor piercing
...
var max_ammo:int = 1 # Maximum ammo the gun has
var ammo:int = max_ammo # The ammo left in mag
var shoot_cooldown:float = .3 # How long in seconds it takes to shoot next bullet
var current_cooldown:float = shoot_cooldown * 5 # Main purpose of this is to give time for anim "ready gun" to play
var damage:float = 75 # How much damage each bullet does
